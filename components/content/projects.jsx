        ...
        <div className="col-span-4 flex flex-col gap-6">
          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-2">
              ...
              <p className="text-sm max-w-sm md:max-w-full">My personal portfolio, the current site you're visiting!</p>
            </div>
            <div className="flex flex-col gap-2">
              <div className='flex items-center gap-2'>
              ...
              <p className="text-sm max-w-sm md:max-w-full">Multipurpose discord bot with plenty of features.</p>
            </div>
            <div className="flex flex-col gap-2">
              <div className='flex items-center gap-2'>
              ...
              <p className="text-sm max-w-sm md:max-w-full">Anime forums where you can meet likeminded people and participate in community activities & more!</p>
            </div>
          </div>
        </div>
    )
